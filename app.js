...
const MockData = (() => {
  ...
  const products = [
    {
      id: 'prod_001',
      name: 'The Ultimate UI/UX Design System',
      description: 'A comprehensive design system with 200+ components, design tokens, and documentation for Figma & Sketch.',
      price: 4900,
      formatted_price: '$49',
      currency: 'usd',
      sales_count: 342,
      sales_usd_cents: 342 * 4900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/uiux-system',
      published: true,
      status: 'published',
    ...
    {
      id: 'prod_002',
      name: 'Full-Stack JavaScript Masterclass',
      description: '40+ hours of video content covering React, Node.js, PostgreSQL, and deployment. Includes source code & exercises.',
      price: 7900,
      formatted_price: '$79',
      currency: 'usd',
      sales_count: 587,
      sales_usd_cents: 587 * 7900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/fullstack-js',
      published: true,
      status: 'published',
      tags: ['course', 'javascript', 'react'],
    ...
    },
    {
      ...
      description: 'The all-in-one Notion template for managing your habits, projects, finances, goals, and journal.',
      price: 1900,
      formatted_price: '$19',
      currency: 'usd',
      sales_count: 1253,
      sales_usd_cents: 1253 * 1900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/notion-os',
      published: true,
      status: 'published',
    ...
    {
      id: 'prod_004',
      name: 'AI Prompt Engineering eBook',
      description: '300-page guide to mastering prompt engineering for ChatGPT, Claude, and Gemini with 150+ tested prompts.',
      price: 2900,
      formatted_price: '$29',
      currency: 'usd',
      sales_count: 891,
      sales_usd_cents: 891 * 2900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/ai-prompts',
      published: true,
      status: 'published',
      tags: ['ebook', 'ai', 'prompts'],
      created_at: '2025-12-01T08:00:00Z',
      updated_at: '2026-05-30T09:00:00Z',
    },
    {
      id: 'prod_005',
      name: 'Indie SaaS Starter Kit',
      description: 'Production-ready SaaS boilerplate with auth, billing (Stripe), dashboards, emails, and admin panel. Next.js + Supabase.',
      price: 14900,
      formatted_price: '$149',
      currency: 'usd',
      sales_count: 134,
      sales_usd_cents: 134 * 14900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/saas-kit',
      published: true,
      status: 'published',
      tags: ['software', 'saas', 'boilerplate'],
      created_at: '2025-10-20T12:00:00Z',
      updated_at: '2026-04-10T16:00:00Z',
    },
    {
      id: 'prod_006',
      name: 'Minimal Icon Pack (1,200 icons)',
      description: 'Hand-crafted, pixel-perfect SVG icon set in 4 styles: outline, solid, duo-tone, and gradient.',
      price: 3900,
      formatted_price: '$39',
      currency: 'usd',
      sales_count: 467,
      sales_usd_cents: 467 * 3900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/icon-pack',
      published: true,
      status: 'published',
    ...
    },
    {
      ...
      description: 'Legally reviewed contract templates for freelancers: NDA, MSA, SOW, and invoice templates in .docx & Notion.',
      price: 2400,
      formatted_price: '$24',
      currency: 'usd',
      sales_count: 312,
      sales_usd_cents: 312 * 2400,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/contracts',
      published: true,
      status: 'published',
      tags: ['template', 'freelance', 'legal'],
      created_at: '2026-01-15T11:00:00Z',
      updated_at: '2026-05-05T14:00:00Z',
    },
    {
      id: 'prod_008',
      name: 'Advanced Python Data Science Course',
      description: 'Deep-dive into pandas, scikit-learn, TensorFlow, and data visualization. 25 real-world projects included.',
      price: 5900,
      formatted_price: '$59',
      currency: 'usd',
      sales_count: 205,
      sales_usd_cents: 205 * 5900,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/python-ds',
      published: true,
      status: 'published',
      tags: ['course', 'python', 'data-science'],
      created_at: '2026-02-01T09:00:00Z',
      updated_at: '2026-05-15T10:00:00Z',
    },
    {
      id: 'prod_009',
      name: 'Startup Financial Model (Google Sheets)',
      description: 'Investor-ready financial model with MRR forecasting, cohort analysis, burn rate, and cap table templates.',
      price: 4400,
      formatted_price: '$44',
      currency: 'usd',
      sales_count: 178,
      sales_usd_cents: 178 * 4400,
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/fin-model',
      published: false,
      status: 'draft',
      tags: ['template', 'startup', 'finance'],
      created_at: '2026-03-10T13:00:00Z',
      updated_at: '2026-05-28T17:00:00Z',
    },
    {
      id: 'prod_010',
      name: 'Lo-fi Music Production Pack',
      description: '500+ royalty-free lo-fi samples, loops, drum kits, and Ableton project files for music producers.',
      price: 3400,
      formatted_price: '$34',
      currency: 'usd',
      sales_count: 0,
      ...
      thumbnail_url: '',
      preview_url: 'https://gumroad.com',
      short_url: 'https://gum.co/lofi-pack',
      published: false,
      status: 'archived',
      tags: ['music', 'samples', 'lofi'],
